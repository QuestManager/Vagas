...
// Endpoint: https://swapi.co/api/species/
export interface ISpecies {
  ...
  people: string[]; // An: string[]; of People URL Resources that are a part of this species.
  films: string[]; // An: string[]; of Film URL Resources that this species has appeared in.
