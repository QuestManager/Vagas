...
export interface IPlanet {
  ...
  residents: string[]; // An: string[]; of People URL Resources that live on this planet.
  films: string[]; // An: string[]; of Film URL Resources that this planet has appeared in.
